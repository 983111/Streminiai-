...
class _HomeScreenState extends ConsumerState<HomeScreen>
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ── Greeting (matches screenshot exactly) ──────────────
                    Text(
                      _greeting(),
  ...
  // ── System Access (matches screenshot rows) ────────────────────────────────
  ...
  // ── Modules grid (2×2 matching screenshot) ─────────────────────────────────
            ...
            Expanded(
              child: _moduleCard(
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const StreminiAgentScreen()),
                ),
              ),
            ),
            const SizedBox(width: 12),
      ...
      items: [
        ...
        AppDrawerItem(
          ...
          onTap: () {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (_) => const StreminiAgentScreen()));
          },
        ),
        AppDrawerItem(
